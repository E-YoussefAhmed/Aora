...
const Create = () => {
  ...
  const [form, setForm] = useState<CreateProps>({
    title: "",
    video: null,
    thumbnail: null,
    prompt: "",
  ...
  // ! This is when using Document Picker
  ...
  // ! This is for using Image Picker
  // const openPicker = async (selectType: "video" | "image") => {
  ...
  return (
    <SafeAreaView className="bg-primary h-full">
      <ScrollView className="px-4 my-6">
        ...
        <View className="mt-7 space-y-2">
          ...
          <TouchableOpacity onPress={() => openPicker("image")}>
            {form.thumbnail ? (
              ...
              <View
                className="w-full h-16 px-4 bg-black-100 rounded-2xl space-x-2
              justify-center items-center border-2 border-black-200 flex-row"
              >
                <Image
                  source={icons.upload}
                  resizeMode="contain"
        ...
        <CustomButton
          title={uploading ? "Submitting..." : "Submit & publish"}
